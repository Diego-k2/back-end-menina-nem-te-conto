...
public class Vagas {
    ...
    @Column(name = "hr_postagem")
    private String hrPostagem;
    ...
    public String getHrPostagem() {
        return hrPostagem;
    }

    public void setHrPostagem(String hrPostagem) {
        this.hrPostagem = hrPostagem;
    }
